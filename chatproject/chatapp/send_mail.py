...
def send_subscription_confirmation(user_subscription):
    ...
    context = {
        ...
        "payment_amount": payment.amount if payment else None,  # Payment amount (if available)
        "payment_currency": payment.currency if payment else 'INR',  # Payment currency (if available)
        "payment_id": payment.payment_id if payment else None,  # Payment ID (if available)
        "payment_status": payment.payment_status if payment else None,  # Payment status (if available)
        "payment_date": payment.payment_date if payment else None,  # Payment date (if available)
    }
