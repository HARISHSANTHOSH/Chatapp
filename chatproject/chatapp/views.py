...
from chatapp import controllers, serializers,constants
...
class CreateCheckoutSessionView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        active_subscription = models.UserPay.objects.filter(
        ...
        if active_subscription:
            return Response(
                {"result": False, "message": f"You are already subscribed to the {plan_id.capitalize()} Plan."},
